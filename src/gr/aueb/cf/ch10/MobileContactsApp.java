                ...
                try {
                    ...
                    switch (choice) {
                        ...
                        case 3:
                            phoneNumber = getPhoneNumber();
                            printContactMenu();
                            updateController(phoneNumber, getFirstname(), getFirstname(), getPhoneNumber());
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            String[][] allContacts = getAllContactController();
    ...
    public static void updateController(String oldPhoneNumber, String firstname, String lastname, String newPhoneNumber) {
        try {
            ...
            if (oldPhoneNumber.length() < 2 || oldPhoneNumber.length() > 50) {
                throw new IllegalArgumentException("Old phone number are not allowed");
            }
            ...
            if (newPhoneNumber.length() < 2 || newPhoneNumber.length() > 50) {
                throw new IllegalArgumentException("New phonenumber is not valid");
            }

            //Service call
            updateContactService(oldPhoneNumber.trim(), firstname.trim(), lastname.trim(), newPhoneNumber);
        } catch (IllegalArgumentException e) {
//            e.printStackTrace();
            throw e;
        }
...
//            e.printStackTrace();
    ...
    public static String[][] getAllContactController() {
        try {
