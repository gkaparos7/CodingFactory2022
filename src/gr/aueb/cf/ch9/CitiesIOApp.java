...
/**
 * diavazei apo ena arxeio me morfh dedomenon
 * country1 city1 city2 city3...
 * country2 city1 city2 city3 ....
 * ....
 * kai grafei kathe grammi se diaforetiko output
 * arxeio..
 *
 * xrisimopoioume to java.io package
 */
            ...
            while ((line = bf.readLine()) != null) {
                ...
                switch (cities[0]) {
                    case "Greece" :
                        ...
                        break;
                    case "USA" :
                        File usaFile = new File(dir + "/ " + cities[0].substring(0, 3).toLowerCase() + ".txt");
